Feature: My Tickets Dashboard
  ...
  Scenario: Viewing my personal dashboard
    Given the following tickets exist:
      ...
      | Fix CSS bug    | styling issue  | open     | low      | Feature Request  | alice@example.com   | agent_alice@example.com  |
      | Close incident | rollback deploy| resolved | high     | Technical Issue  | bob@example.com     | agent_alice@example.com  |
